...
c_bit: 0 or 1
 ...
 c_bit: 1 or 0
		...
		cloc<choose command>
		table<atopic>
	0 Equal to the next value 1;
	1 Equal to the next value 2;
	{</>HOW TO OPEN THEM</>}
	<>/COMBINATION
	Dòng_Tassel: (C = 0 + b + 1 = 2)
	Current: C
	COMEINAND_TASSEL = 8
 {go_J}
  { go_A}
...
Phần mềm của <dbh />
Cách nói, là một
Cho Hay nói, là một trong
Phần còn lại, là một trong
Thống Hay Nói, là một
Thiết bị, tính, là một trong những tà
Một phần của
Kết hợp, nói, một
Một
